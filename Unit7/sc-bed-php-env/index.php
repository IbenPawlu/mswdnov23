...
class Employee{
    ...
    // Setting the functions of the Object
...
$emp3 = new Employee('Claire', 'Gatt', 'Junior Programmer', 30);
...
<body>
    <h1>OOP</h1>
    <p> <?= $emp1->getBasicDetailsString()?> </p>
    <p><?= $emp2->getBasicDetailsString()?></p>
    <p> Name: <?= $emp3->getBasicDetailsString()?> </p>
    <p> Wage: <?= $emp3->getGrossPay(160) ?> </p>
    ...
    <?php
        ...
        function describeHuman(PayrollWorker $human): string{
            return sprintf('<p>%s %s (%s)', $human->getName(), $human->getSurname(), $human->getRoleDescription());
        }
